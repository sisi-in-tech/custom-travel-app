...
export default function NavigationBar() {
  ...
  <a href="https://" className="flex items-center space-x-3 rtl:space-x-reverse">
      <Image src="/Images/navbar.png" width={70} height={60} className="h-13" alt="Flowbite Logo" />
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Allpro Travel</span>
  </a>
